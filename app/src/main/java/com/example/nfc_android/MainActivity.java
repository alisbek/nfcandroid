...
//Все тексты in english
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btnWrite = findViewById(R.id.button); // получаем элемент кнопка "Записать"

        // устанавливаем событие на нажатие кнопки
            ...
            public void onClick(View v) {
                try {
                    if(myTag == null) {
                        ...
                        // запись сообщения к считывателю
...
//        String tagId = new String(msgs[0].getRecords()[0].getType());
    ...
    //если пользователь решит перейти к другой activity, то система вызывает метод onPause
    //в этом режиме отключаем запись
    @Override
    public void onPause(){
        super.onPause();
        WriteModeOff();
    ...
    //в этом режиме пользователь может взаимодействовать с приложением
    @Override
